...
- [Birthday party places](https://www.kidsbayarea.com/en/guides/birthday-party): Best Bay Area kids' birthday party venues — indoor playgrounds (La Petite Playhouse, WOW Kids), trampoline parks (Sky Zone), entertainment centers (Round1), and outdoor options. Includes a Q&A on the best party venues by age group (toddlers to tweens), outdoor parties, and unique party ideas.
- [Free activities for kids](https://www.kidsbayarea.com/en/guides/free): Free family activities across the Bay Area — parks, beaches, free-admission venues (Tilden Little Farm, Randall Museum, Baker Beach), splash pads (24th & York, Ortega Park), and free East Bay outdoor highlights. Includes a Q&A on the best free activities by region and age group.
